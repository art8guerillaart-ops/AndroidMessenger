...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "BASE_URL", "\"https://my-messenger-2cir.onrender.com\"")
    }
...
dependencies {
    ...
    // ProcessLifecycleOwner — нужен, чтобы понять, свёрнуто ли приложение
    // (показывать уведомление о новом сообщении только пока оно в фоне).
